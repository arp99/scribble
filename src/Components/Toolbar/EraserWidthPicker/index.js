...
/**
 * Shows the slider change the eraser width
 */
const EraserWidthPicker = ({ isOpen, setIsOpen, children }) => {
  ...
  return (
    <div
      id="eraser-width-tool__container"
      onClick={() => {
        setIsOpen(true);
      }}
      ref={ref}
    >
      <a data-tooltip-id="eraser-width-click">{children}</a>
      <Tooltip
        clickable
        id="eraser-width-click"
        isOpen={isOpen}
        opacity={1}
        style={{
...
export default EraserWidthPicker;
